...
app.post('/admin/editColab', async (req, res, next) => {
...
app.post('/admin/deactivateColab', async (req, res, next) => {
...
app.post('/admin/deleteColab', async (req, res, next) => {
    const { id_usuario } = req.body;
...
app.post('/admin/registerColab', async (req, res, next) => {
    const {
...
app.post('/admin/edit', async (req, res, next) => {
...
app.get('/admin/buscarUsuarios', verificarAutenticacion, async (req, res, next) => {
